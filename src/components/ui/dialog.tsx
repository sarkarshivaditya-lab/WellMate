    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "glass-elevated text-card-foreground rounded-2xl",
          "grid gap-4 p-6 max-h-[85dvh] overflow-y-auto",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              "absolute right-4 top-4 rounded-lg min-h-10 min-w-10",
              "flex items-center justify-center opacity-75 hover:opacity-100 transition-opacity",
              "focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ring-offset-card",
