          ...
          <CardContent className="space-y-4">
            ...
            {!isLoading && !isAuthenticated && (
              <>
                ...
                <div className="rounded-xl border border-border/60 p-4 space-y-2">
                  <div className="text-sm font-medium">Sign in to enable sync & backup</div>
                  <div className="text-xs text-muted-foreground">Signing in lets you back up your data and access it on other devices. Your app works fully offline even without signing in.</div>
                </div>
            ...
            {!isLoading && isAuthenticated && (
              <>
                ...
                <div className="rounded-xl border border-border/60 p-4 space-y-2">
                  <div className="text-sm font-medium">Account connected</div>
                  <div className="text-xs text-muted-foreground">Your data can now be securely synced and backed up.</div>
                </div>
                <Button
                  className="w-full"
                  variant="secondary"
          ...
          <Card className="glass-secondary border-primary/25 hover:border-primary/40 hover:bg-primary/[0.04] transition-premium">
            <CardContent className="pt-4 pb-4 flex items-center justify-between gap-3">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground pl-6">Roadmap, vision, and future integrations</p>
              </div>
        ...
        <Card className="glass-subtle border-amber-200/50">
          ...
          <CardContent className="space-y-3">
            <p className="text-xs text-muted-foreground">
              WellMate provides wellness guidance, health tracking, and emergency-support features. AI guidance is not medical advice or a replacement for emergency care. Please keep your emergency profile accurate.
            </p>
            <Button variant="outline" size="sm" className="w-full" onClick={() => setSafetySheetOpen(true)}>
        ...
        <Sheet open={safetySheetOpen} onOpenChange={setSafetySheetOpen}>
          <SheetContent side="bottom" className="h-[90vh] flex flex-col rounded-t-2xl gap-0 overflow-hidden">
            <SheetHeader className="flex-shrink-0 pb-3">
              ...
              <SheetDescription>WellMate's current health, safety, and privacy terms.</SheetDescription>
            </SheetHeader>
